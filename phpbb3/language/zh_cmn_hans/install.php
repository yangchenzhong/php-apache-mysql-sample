...
$lang = array_merge($lang, array(
	...
	'EDIT_USERNAME'	=> '编辑用户名',
	'ERROR'			=> '错误',
	'EVERYTHING_UP_TO_DATE'		=> '你已升级到了最新phpBB版本，你现在应该<a href="%1$s">登录你的论坛</a>检查所有功能是否工作正常。别忘了删除、重命名或移动install文件夹！请给我们发送升级信息，在ACP里的<a href="%2$s">发送统计信息</a>模块可以找到有关你的服务器和论坛的配置。',
